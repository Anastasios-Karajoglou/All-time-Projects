<!-- ΚΑΤΗΓΟΡΙΕΣ Μοντέλων -->
<!-- Πρωινό Μοντέλο -->
<div class="modal fade mt-5" id="breakfastModal" tabindex="-1" aria-labelledby="breakfastModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        ...
        <div class="row modal-body">
            ...
            <?php 
                ...
                // Βρόχος για την εμφάνιση των αποτελεσμάτων
                foreach ($result as $row) {
                    ...
                    <div class="card" style="width:185px; height:200px; margin: 20px">
                        <div class="d-flex justify-content-center align-items-center" style="max-height: 120px;">
                            <img  src="http://localhost/project/uploads/<?php echo $recipeImage ?>" class="card-img-top mt-1" alt="Recipe" style="max-width: 120px; max-height: 180px;">
                        </div>
                        <div class="card-body">
...
<!-- Μεσημεριανό Μοντέλο -->
<div class="modal fade mt-5" id="lunchModal" tabindex="-1" aria-labelledby="lunchModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
        <div class="modal-header">
    ...
    <!-- Μοντέλο Δείπνου -->
    <div class="modal fade mt-5" id="dinnerModal" tabindex="-1" aria-labelledby="dinnerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
        <div class="modal-header">
...
<!-- Μοντέλο Ορεκτικού -->
<div class="modal fade mt-5" id="appetizerModal" tabindex="-1" aria-labelledby="appetizerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
        <div class="modal-header">
...
<<!-- Μοντέλο Γλυκού -->
<div class="modal fade mt-5" id="dessertModal" tabindex="-1" aria-labelledby="dessertModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
        <div class="modal-header">
...
<!-- Fast Food Μοντέλο -->
<div class="modal fade mt-5" id="fastFoodModal" tabindex="-1" aria-labelledby="fastFoodModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
        <div class="modal-header">
...
<!-- Μοντέλα ΛΙΣΤΑΣ ΦΑΓΗΤΩΝ -->

<!-- Μοντέλο Προσθήκη Συνταγής -->
 <div class="modal fade mt-5" id="addRecipeModal" tabindex="-1" aria-labelledby="addRecipeModalLabel" aria-hidden="true">
...
<!-- Μοντέλο Εμφάνισης Συνταγής -->
<div class="modal fade mt-5" id="viewRecipeModal" tabindex="-1" aria-labelledby="viewRecipeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
        <div class="modal-header">
...
<!-- Μοντέλο Ενημέρωσης Συνταγής -->
<div class="modal fade mt-5" id="updateRecipeModal" tabindex="-1" aria-labelledby="updateRecipeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
